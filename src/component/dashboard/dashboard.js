    ...
    >
      ...
      <div>
        <div>
          {/* for div */}
          <div>
            <div direction="column" style={{ padding: "30px" }}>
              {/* SOINS */}
              <div>
                <p
                  style={{
                    ...
                    <TableBody>
                          ...
                          >
                            ...
                            >
                              <svg
                                ...
                                viewBox="0 0 30 28"
                                fill={
                                  removedTooth.includes(chrome)
                                    ? `${removeToothAlert.color}`
                                    : "white"
                                }
                                xmlns="http://www.w3.org/2000/svg"
                              >
                      ...
                      <TableRow>
                        ...
                        {teethGroup2.map((chrome) => (
                          <TableCell
                            style={{ borderBottom: "0px", width: "10px" }}
                          >
                            <a
                              onClick={() => {
                                if (!removedTooth.includes(chrome)) {
      ...
      <Grid item style={{ marginTop: "-30px" }}>
        ...
        <Grid container xs={12}>
          <Grid item md={6} xs={10} style={{ padding: "30px 14px 100px 30px" }}>
            <Grid container direction="column">
              <CardSt />
            </Grid>
          </Grid>
          <Grid item md={6} xs={10} style={{ padding: "30px 30px 100px 14px" }}>
            <CardComp />
          </Grid>
        </Grid>
      </Grid>
